...
class PermissionCatalog
{
                ...
                collect(config('access.areas'))->keys()->flatMap(fn (string $areaKey) => (
                    collect(config('access.boards'))
                        ...
                        ->reject(function (string $boardKey) use ($areaKey): bool {
                            ...
                            if ($boardKey === 'ficha_empleados' && $areaKey !== 'gestion_humana') {
                                return true;
                            }

                            if ($boardKey === 'archivo' && $areaKey !== 'gestion_humana') {
                                return true;
                            }

                            if ($boardKey === 'plantillas_word' && $areaKey !== 'gestion_humana') {
                                return true;
                            }
                            ...
                            if ($boardKey === 'cursos' && $areaKey !== 'gestion_humana') {
                                return true;
                            }
    ...
    /**
     * Garantiza que todos los permisos configurados existan en Spatie.
