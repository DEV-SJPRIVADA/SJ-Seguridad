...
class UpdateAcreditacionAcreditadoRequest extends FormRequest
{
    ...
    {
        /** @var AcreditacionAcreditado $acreditacionAcreditado */
        $acreditacionAcreditado = $this->route('acreditacionAcreditado');
        ...
        return [
            ...
            'cargo_apo' => [
                ...
                Rule::unique('acreditacion_acreditados', 'cargo_apo')
                    ...
                    ->ignore($acreditacionAcreditado->id),
            ],
