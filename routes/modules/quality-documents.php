...
Route::middleware(['auth', 'active', 'password.changed'])->prefix('quality-documents/{module}')->name('quality-documents.')->group(function () {
    ...
    Route::get('/biblioteca/exportar', [QualityDocumentController::class, 'libraryExport'])->name('library.export');
    ...
    Route::get('/mis-documentos/exportar', [QualityDocumentController::class, 'mineExport'])->name('mine.export');
    ...
    Route::middleware(['can:manage.quality.documents'])->prefix('administrar')->name('admin.')->group(function () {
        ...
        Route::get('/exportar', [QualityDocumentController::class, 'adminExport'])->name('export');
