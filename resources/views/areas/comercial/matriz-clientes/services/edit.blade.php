<x-app-layout>
    <x-slot name="header">
        <div class="app-container" style="padding-top: 0.75rem; padding-bottom: 0.75rem;">
            ...
            <p class="panel-text" style="margin:0.25rem 0 0;">{{ $client->name }} · {{ $service->contract_number ?: 'Sin contrato' }}</p>
        </div>
    </x-slot>
    ...
    <div class="page-section">
        <div class="app-container">
            <div class="panel">
                <form method="POST" action="{{ route('comercial.matriz.services.update', [$client, $service]) }}" class="panel__body form-stack">
                    @csrf
                    @method('PATCH')
