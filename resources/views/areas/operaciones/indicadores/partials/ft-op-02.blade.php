<div class="indicadores-field-grid">
    ...
    <div>
        ...
        <input type="number" step="0.01" name="form[no_conformes]" value="{{ old('form.no_conformes', $form['no_conformes'] ?? '') }}" class="supply-input js-capture-field" data-field="no_conformes" @disabled($isPeriodClosed || ($readOnly ?? false)) />
    </div>
</div>
