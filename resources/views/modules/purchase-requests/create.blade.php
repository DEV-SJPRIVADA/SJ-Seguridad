                            ...
                            <table class="supply-table">
                                ...
                                <tbody id="purchase-items-container">
                                    <tr data-purchase-item-row>
                                        ...
                                        <td>
                                            <input type="text" name="items[0][referencia]" class="supply-input" value="{{ old('items.0.referencia') }}" placeholder="Referencia / codigo" required>
                                        </td>
                                        <td>
                                            <input type="text" name="items[0][utilizacion]" class="supply-input" value="{{ old('items.0.utilizacion') }}" placeholder="Uso previsto" required>
                                        </td>
                                        <td>
