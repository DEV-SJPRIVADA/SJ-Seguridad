...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| FEAT-035 | Tablero Selección GH (Dashboard, Ingreso, Examen ocupacional, Catálogos) | orquestado | Post-Brief — pausa confirmacion | 2026-09-22 seleccion GH | — | [`docs/briefs/FEAT-035.md`](briefs/FEAT-035.md) | [`docs/runs/FEAT-035-run-log.md`](runs/FEAT-035-run-log.md) | `config/access.php`, rutas GH, nav, `config/employee_ficha.php`, `config/audit.php` |
| FEAT-034 | Cola «Nuevos sin curso» en Cursos (icono+contador; enqueue post go-live) | orquestado | Feature T2 (hooks Ficha) | 2026-09-21 cola pendientes cursos | — | [`docs/briefs/FEAT-034.md`](briefs/FEAT-034.md) | [`docs/runs/FEAT-034-run-log.md`](runs/FEAT-034-run-log.md) | parcial: rutas GH + `FichaEmpleadosController` + `EmployeeFichaImportService` (**no** `access.php`) |
