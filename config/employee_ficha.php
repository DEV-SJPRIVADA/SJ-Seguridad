...
return [
    ...
    'import_columns' => [
        ...
        'tipo_documento' => 'Tipo documento (C, CE, N, TI, PT o CEDULA/NIT)',
        'edad' => 'Edad (opcional)',
        ...
        'sexo' => 'Sexo (M/F o Masculino/Femenino)',
        'salario' => 'Salario',
        ...
        'tipo_cotizante' => 'Tipo cotizante (opcional)',
        ...
        'escala' => 'Escala (opcional)',
        'tipo_salario' => 'Tipo salario',
        'tipo_contrato' => 'Tipo contrato',
        'ultimo_periodo_vacaciones' => 'Último periodo vacaciones (opcional)',
        'total_dias_vacaciones' => 'Total días vacaciones (opcional)',
        'periodos_pendientes_vacaciones' => 'Periodos pendientes vacaciones (opcional)',
        'excedente_pdte_vacaciones' => 'Excedente pendiente vacaciones (opcional)',
        'dias_pendientes_a_disfrutar' => 'Días pendientes a disfrutar (opcional)',
        'valor_pendiente_de_vacaciones' => 'Valor pendiente de vacaciones (opcional)',
        ...
        'tipo_de_cuenta' => 'Tipo cuenta (1/2 o Ahorro/Corriente)',
        ...
        'codigo_ciudad_trabajo' => 'Código ciudad de trabajo (opcional)',
        'ciudad_trabajo' => 'Ciudad de trabajo (opcional)',
    ...
    */
    ...
    'letter_placeholders' => [
        'Sistema' => [
            'FECHA' => 'Fecha de emision de la carta',
            'FIRMA' => 'Nombre del firmante',
            'CARGO_FIRMA' => 'Cargo del firmante',
        ],
        'Datos del empleado (Perfil)' => [
            ...
            'TIPO_VINCULACION' => 'Tipo de vinculacion',
            'FECHA_CONTRATO' => 'Fecha de contrato (perfil)',
            'FECHA_TERMINACION_PERFIL' => 'Fecha de terminacion (perfil)',
            'ESTADO_LABORAL' => 'Estado laboral (activo/desvinculado)',
            'CENTRO_TRABAJO' => 'Centro de trabajo',
            'CENTRO_COSTO' => 'Codigo del centro de costo',
            'CENTRO_COSTO_NOMBRE' => 'Nombre del centro de costo',
            'CARGO' => 'Cargo',
            'CODIGO_CARGO' => 'Codigo del cargo',
            'TIPO_SALARIO' => 'Tipo de salario',
            'TIPO_CONTRATO_PERFIL' => 'Tipo de contrato (perfil)',
            'EPS' => 'EPS',
            'AFP' => 'AFP',
            'ARP' => 'ARP',
            'NIVEL_RIESGO' => 'Nivel de riesgo',
            'FONDO_COMPENSACION' => 'Fondo de compensacion',
            'BANCO' => 'Banco',
            'TIPO_CUENTA' => 'Tipo de cuenta bancaria',
            'NUMERO_CUENTA' => 'Numero de cuenta bancaria',
            'METODO_PAGO' => 'Codigo de metodo de pago',
            'ACTIVIDAD_ECONOMICA' => 'Actividad economica',
        ],
        'Datos del empleado (Entrada ficha)' => [
            'CEDULA' => 'Documento de identidad (entrada)',
            'NOMBRE_COMPLETO_ENTRADA' => 'Nombre completo (entrada)',
            'FECHA_MUDANZA_FICHA' => 'Fecha de mudanza a ficha',
        ],
        'Datos del vinculo (periodo)' => [
            'NUMERO_VINCULO' => 'Numero secuencial del vinculo',
            'FECHA_INGRESO' => 'Fecha de ingreso',
            'SALARIO_VINCULO' => 'Salario del vinculo',
            'CODIGO_CARGO_VINCULO' => 'Codigo del cargo (vinculo)',
            'CARGO_VINCULO' => 'Cargo (vinculo)',
            'CENTRO_COSTO_VINCULO' => 'Centro de costo (vinculo)',
            'CENTRO_COSTO_NOMBRE_VINCULO' => 'Nombre centro de costo (vinculo)',
            'TIPO_CONTRATO_VINCULO' => 'Codigo tipo de contrato (vinculo)',
            'TIPO_CONTRATO_NOMBRE_VINCULO' => 'Nombre tipo de contrato (vinculo)',
            'FECHA_FIN_CONTRATO' => 'Fecha fin de contrato',
            'CENTRO_TRABAJO_VINCULO' => 'Centro de trabajo (vinculo)',
            'EPS_VINCULO' => 'EPS (vinculo)',
            'AFP_VINCULO' => 'AFP (vinculo)',
            'TIPO_VINCULACION_VINCULO' => 'Tipo de vinculacion (vinculo)',
            'CAUSAL_TERMINACION' => 'Codigo causal de terminacion',
            'CAUSAL_TERMINACION_NOMBRE' => 'Nombre causal de terminacion',
            'RECONTRATABLE' => 'Recontratable (Si/No)',
            'ULTIMO_DIA_LABORES' => 'Ultimo dia de labores',
            'FECHA_TERMINACION_VINCULO' => 'Fecha de terminacion (vinculo)',
        ...
        'Datos de la requisicion' => [
            'CODIGO_REQUISICION' => 'Codigo de la requisicion',
            'SOLICITADO_POR' => 'Solicitado por (nombre)',
            'GERENTE' => 'Gerente (nombre)',
            'FECHA_SOLICITUD' => 'Fecha de solicitud',
            'LIDER' => 'Lider',
            'AREA_SOLICITANTE' => 'Area solicitante',
            'CARGO_REQUISITO' => 'Cargo requerido',
            'SEXO_REQUISICION' => 'Sexo requerido',
            'CANTIDAD' => 'Cantidad solicitada',
            'DOCUMENTO_REEMPLAZO' => 'Documento del reemplazado',
            'NOMBRE_REEMPLAZO' => 'Nombre del reemplazado',
            'DURACION_CONTRATO' => 'Duracion del contrato',
            'SALARIO_BASE' => 'Salario base (requisicion)',
            'AUXILIO_TRANSPORTE' => 'Auxilio de transporte',
            'AUXILIO_MOVILIDAD' => 'Auxilio de movilidad',
            'PRIMA_ESTATUTARIA' => 'Prima estatutaria',
            'PRIMA_NO_ESTATUTARIA' => 'Prima no estatutaria',
            'OTROS_AUXILIOS' => 'Otros auxilios',
            'CONTRATO_ARRENDAMIENTO' => 'Contrato de arrendamiento',
            'AREA_OPERATIVA' => 'Area operativa',
            'MOTIVO_SOLICITUD' => 'Motivo de solicitud',
            'CLIENTE' => 'Cliente',
            'CIUDAD_REQUISICION' => 'Ciudad (requisicion)',
            'TIPO_CLIENTE' => 'Tipo de cliente',
            'TIPO_PROGRAMACION' => 'Tipo de programacion',
            'PERFIL_REQUERIDO' => 'Perfil requerido',
            'UNIFORME' => 'Uniforme',
            'ESTRUCTURA_SERVICIO' => 'Estructura del servicio',
            'CENTRO_COSTO_REQUISICION' => 'Centro de costo (requisicion)',
            'OBSERVACIONES_SOLICITANTE' => 'Observaciones del solicitante',
            'OBSERVACIONES_RH' => 'Observaciones de recursos humanos',
